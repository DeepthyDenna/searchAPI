...
public class SearchRequestTest {
	...
	private static final Logger logger = Logger.getLogger(SearchRequestTest.class.getName());

	public static <MusicResultList> src.MusicResultList search(ItunesSearchParams params) {
		URL url;
